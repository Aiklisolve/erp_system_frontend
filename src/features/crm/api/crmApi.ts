...
// Flag to use backend API for tasks
const USE_BACKEND_API = true; // Use backend API by default for tasks

// Flag to use mock data if backend API is unavailable (for other APIs)
let useStatic = false;
